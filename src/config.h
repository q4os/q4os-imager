...
/* Repository URL */
#define OSLIST_URL                        "https://github.com/q4osteam/q4os-install-media/releases/download/v4/os_list_imagingutility_v3_q4os.json"

/* Time synchronization URL (only used on eglfs QPA platform, URL must be HTTP) */
#define TIME_URL                          "http://github.com/q4osteam/q4os-install-media/releases/download/v4/os_list_imagingutility_v3_q4os.json?time_synchronization"

/* Phone home the name of images downloaded for image popularity ranking */
#define TELEMETRY_URL                     "https://q4os.org/touch/.tst_rpimgr"
